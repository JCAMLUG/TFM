...
def play_quadrapong(round_num=1700): # Se define la ronda a evaluar
    ...
    model_paths = {
        "first_0": f"models_quadrapong/modelos_train_2000/quadrapong_agent_first_0_round{round_num}.zip",
        "second_0": f"models_quadrapong/modelos_train_2000/quadrapong_agent_second_0_round{round_num}.zip",
        "third_0": f"models_quadrapong/modelos_train_2000/quadrapong_agent_third_0_round{round_num}.zip",
        "fourth_0": f"models_quadrapong/modelos_train_2000/quadrapong_agent_fourth_0_round{round_num}.zip",
    }
