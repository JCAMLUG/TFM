...
def play_quadrapong_zero(round_num=2000): # Se define la ronda a evaluar
    ...
    model_paths = {
        "first_0": f"models_quadrapong_zero/quadrapong_agent_first_0_round{round_num}.zip",
        "second_0": f"models_quadrapong_zero/quadrapong_agent_second_0_round{round_num}.zip",
        "third_0": f"models_quadrapong_zero/quadrapong_agent_third_0_round{round_num}.zip",
        "fourth_0": f"models_quadrapong_zero/quadrapong_agent_fourth_0_round{round_num}.zip",
    }
    ...
    os.makedirs("videos/quadrapong_zero", exist_ok=True)

    # Se guarda en video como mp4 con 30 fps
    video_path = os.path.join("videos/quadrapong_zero", f"quadrapong_zero_round{round_num}.mp4")
    imageio.mimsave(video_path, frames, fps=30)
    print(f"Video guardado en {video_path}")

    # Se guarda o se actualiza CSV con recompensas
    csv_file = "videos/quadrapong_zero/eval_rewards_zero.csv"
